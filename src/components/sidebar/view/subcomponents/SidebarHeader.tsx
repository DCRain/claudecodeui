import { Activity, Archive, Folder, FolderOpen, FolderPlus, MessageSquare, Plus, RefreshCw, Search, X, PanelLeftClose } from 'lucide-react';
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <div className="flex flex-shrink-0 gap-1.5">
            ...
            <button
              className="flex h-8 w-8 items-center justify-center rounded-lg bg-muted/50 text-muted-foreground transition-all active:scale-95"
              onClick={onOpenProject}
              title={t('tooltips.openProject')}
            >
