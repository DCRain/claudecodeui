...
export const CLI_PROVIDERS: LLMProvider[] = ['claude', 'cursor', 'codex', 'opencode', 'qoder', 'trae'];
...
export const PROVIDER_AUTH_STATUS_ENDPOINTS: Record<LLMProvider, string> = {
  ...
  trae: '/api/providers/trae/auth/status',
};
...
export const createInitialProviderAuthStatusMap = (loading = true): ProviderAuthStatusMap => ({
  ...
  trae: { authenticated: false, email: null, method: null, error: null, loading },
});
