...
const PROVIDER_SKILL_PATHS: Record<Exclude<SkillsProvider, 'opencode' | 'qoder' | 'trae'>, string> = {
...
export default function ProviderSkills({ selectedProvider, currentProjects }: ProviderSkillsProps) {
  ...
  const providerPath = selectedProvider === 'opencode' || selectedProvider === 'qoder' || selectedProvider === 'trae' ? null : PROVIDER_SKILL_PATHS[selectedProvider];
