import { Settings, ArrowUpCircle, Bug, AlertTriangle, SquareTerminal } from 'lucide-react';
      ...
      {onShowTab && (
        <div className="hidden px-2 md:block">
          ...
          >
            ...
            <span className="text-sm">{t('navigation.terminal')}</span>
          </button>
        </div>
      )}
      ...
      {onShowTab && (
        <div className="px-3 pt-2 md:hidden">
          ...
          >
            ...
            <span className="text-sm font-normal text-foreground">{t('navigation.terminal')}</span>
          </button>
        </div>
      )}
