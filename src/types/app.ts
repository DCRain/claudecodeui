export type LLMProvider = 'claude' | 'cursor' | 'codex' | 'opencode' | 'qoder' | 'trae';
...
export type AppTab = 'chat' | 'files' | 'shell' | 'terminal' | 'home-terminal' | 'git' | 'tasks' | 'browser' | `plugin:${string}`;
