...
export function useShellRuntime({
  ...
  const clientTerminalIdRef = useRef(clientTerminalId);
  ...
  useEffect(() => {
    ...
    clientTerminalIdRef.current = clientTerminalId;
  }, [selectedProject, selectedSession, initialCommand, isPlainShell, onProcessComplete, clientTerminalId]);
